...
public class Meteor 
{
    ...
    public void CreateMeteor()
    {
        ...
        Meteor.AddComponent<BoxCollider2D>().size = new Vector2(5.5f, 5.7f);
        Meteor.GetComponent<BoxCollider2D>().offset = new Vector2(-0.63f, 0.51f);
    ...
    public void CreateSmallMeteors(Vector3 position, Vector3 Move)
    {
        ...
        SmallMeteor1.AddComponent<BoxCollider2D>().size = new Vector2(5.5f, 5.7f);
        SmallMeteor1.GetComponent<BoxCollider2D>().offset = new Vector2(-0.63f, 0.51f);
        ...
        SmallMeteor2.AddComponent<BoxCollider2D>().size = new Vector2(5.5f, 5.7f);
        SmallMeteor2.GetComponent<BoxCollider2D>().offset = new Vector2(-0.63f, 0.51f);
